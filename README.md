...
Le but de ce projet est de récolter des données sur la condition météorologique d'une pièce. Pour cela nous allons créer des modules équipé de capteurs qui seront connecter par wifi à une base de donnée qui transmettra les informations sur site web pour être utilisé par tous.
