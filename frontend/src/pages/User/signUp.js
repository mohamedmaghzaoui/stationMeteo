...
export const SignUp=()=>{
  ...
  const userSchema=yup.object().shape({
    ...
    password:yup.string().required("password isrequired").min(6,"password too short minimum 6 letters"),
    repeatedPassword:yup.string().required("repeat password is required")
  ...
  <label class="form-label" for="form2Example1">Username</label>
    <input
     ...
     {...register("username")} type="text"  class="form-control" />
    {errors.username ?<p className="text-danger"> {errors.username.message}  </p> :<br/>}
  ...
  <label  class="form-label" for="form2Example2">Reapeat Password</label>
    <input  {...register("repeatedPassword")}    type="password"  class="form-control" />
    {errors.repeatedPassword ?<p className="text-danger"> {errors.repeatedPassword.message}  </p> :<br/>}
  </div>
